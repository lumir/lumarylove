...
setInterval(function() {
    var timespan = countdown(new Date("03/09/2014"), new Date());
    var div = document.getElementById('time');
    div.innerHTML = "<div><span>Años</span>" + timespan.years + "</div>" + "<div><span>Meses</span>" + timespan.months + "</div>" + "<div><span>Dias</span>" + timespan.days + "</div>" + "<div><span>Horas</span>" + timespan.hours + "</div>" + "<div><span>Minutos</span>" + timespan.minutes + "</div>" + "<div><span>Segundos</span>" + timespan.seconds + "</div>"
}, 1000);
